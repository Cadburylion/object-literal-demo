...
// GroceryItem Object Constructor
...
// GroceryList Object Constructor
...
GroceryList.prototype.addItem = function(itemName){
  var item = new GroceryItem(itemName); // invokes GroceryItem constructor
...
var cat = new GroceryList ('cats', 'matt');
cat.addItems(['tabby', 'calico', 'bobcat']);
app.appendChild(cat.getTable());
